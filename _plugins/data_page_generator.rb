...
module Jekyll
  ...
  class DataPage < Page
    ...
    def initialize(site, base, index_files, dir, data, name, template, extension)
      @site = site
      @base = base
      haml_converter = Jekyll::Converters::Haml.new Jekyll.configuration
      ...
      if data[name] == nil
        ...
        self.process(@name)
        self.read_yaml(File.join(base, '_layouts'), template + ".haml")
        self.content = haml_converter.convert self.content
